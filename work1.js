...
let n = 2
console.log(`The first 10 multiples of ${n} are:`)
  for (let i = 1; i <= 10; i++) {
    let multiple = n * i;
...
// number 2
  ...
  let sum = 0;
  while (true) {
    let num = Number(prompt("Enter a number (enter a negative number to stop):"))
    if (num < 0) {
      break;
    }
    sum += num;
  ...
  // number 3
    ...
    while (true) {
      let name = prompt("Enter a name (enter 'END' to stop):")
      if (name === "END") {
        break;
      }
